(function () {
  ...
  const a0 = {
    "a0-first-contact": {
      ...
      questions: [
        question("intro", "GUIDED BUILD", "You want to say hello and give your name.", "Introduce yourself as Sam. A greeting is optional.", ["Hallo, ich bin Sam.", "Hallo! Ich bin Sam.", "Hallo, ich heiße Sam.", "Hallo! Ich heiße Sam.", "Ich bin Sam.", "Ich heiße Sam.", "Mein Name ist Sam."], "Hallo can open the exchange. Ich bin, Ich heiße, and Mein Name ist can all give your name.", [], ["Hallo,", "ich", "bin", "Sam."], { title: "Use any taught name pattern", model: "Ich bin Mina. · Ich heiße Mina. · Mein Name ist Mina.", translation: "I am Mina. · My name is Mina.", tip: "Replace Mina with Sam. You may add Hallo." }),
