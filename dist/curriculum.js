(function () {
  ...
  const SOURCES = [
    ...
    { category: "LEARNING DESIGN", title: "Mulder and colleagues: Supportive vocabulary contexts", body: "Supports the use of semantically informative contexts while a learner is establishing a new word.", url: "https://doi.org/10.1017/S0142716418000504" },
    { category: "LEARNING DESIGN", title: "Elgort and colleagues: L2 vocabulary across varied texts", body: "Supports controlled contextual variation after a learner has established an initial form and meaning.", url: "https://doi.org/10.1017/S0142716424000407" },
    { category: "INDUSTRY DESIGN", title: "Duolingo: Monolingual B1 and B2 lesson design", body: "Reviewed as a product example for using known target-language vocabulary, contextual clues, focused grammar contrasts, and optional first-language hints.", url: "https://blog.duolingo.com/how-duolingo-teaches-english/" },
    ...
    { category: "LOCAL SPEECH", title: "Hugging Face: Transformers.js", body: "Runs the optional German transcription model inside the browser. The library and model are downloaded only after the learner chooses local transcription.", url: "https://huggingface.co/docs/transformers.js/" },
    { category: "LOCAL SPEECH", title: "ONNX Community: Whisper Tiny", body: "Provides the browser-ready multilingual Whisper model used for the optional local German transcript tool.", url: "https://huggingface.co/onnx-community/whisper-tiny" },
    { category: "LOCAL SPEECH", title: "OpenAI: Whisper", body: "Provides the multilingual speech-recognition model family used by the optional local transcript tool. Recordings stay in the learner's browser.", url: "https://github.com/openai/whisper" }
  ];
